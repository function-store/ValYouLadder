...
import { IS_SUBMISSIONS_OPEN } from "@/lib/config";
    ...
    <section className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          {!IS_SUBMISSIONS_OPEN && <PreProdBanner message="This is a preview of ValYouLadder. Data shown on this site is for demonstration purposes only and does not reflect real submissions." />}
          {/* Badge */}
